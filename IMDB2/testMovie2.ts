...
console.log("Actors mymovie");
console.log("Actors of mymovie:");
mymovie.actors.forEach((actor) => {
    console.log("--> " + actor.name);
});

console.log("Actors of mymovie2:");
mymovie2.actors.forEach((actor) => {
    console.log("--> " + actor.name);
});

console.log("Actors of mymovie3:");
mymovie3.actors.forEach((actor) => {
    console.log("--> " + actor.name);
});